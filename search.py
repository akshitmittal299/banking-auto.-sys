...
class Search:
    def __init__(self):
        ...
        self.l1=Label(self.root, text="Search Account")
...
##        self.b2=Button(self.f1,text="De",command=self.delete)
...
##    def delete(self):
##        self.ano=str(self.e2.get())
##        self.cursor.execute("delete from tbaccount where acno=%s",(self.e2.get()) )
##        self.conn.commit()
##        self.root.destroy()
##        
##        
