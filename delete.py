...
class Delete:
    def __init__(self):
        ...
        self.l1=Label(self.root, text="Delete Account")
    ...
    def display(self):
        ...
        self.b2=Button(self.f1,text="Delete",command=self.delete)
    ...
    def delete(self):
        ano=self.e2.get()
        self.cursor.execute("delete from tbaccount where acno=%s",(ano) )
        self.conn.commit()
        messagebox.showinfo("Validate","Account no. "+self.e2.get()+" is deleted...")
